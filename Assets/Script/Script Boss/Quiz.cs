    ...
    public void CheckAnswer(string selectedAnswer)
    {
        if (selectedAnswer == Reponse)
        {
            ...
            if (bossHealth <= 0)
            {
                ...
                {
                    ElementalInventory.Instance.addItem("Cle 2", 1, randomColor, "Cle qui ouvre la porte de la salle 2");
                }
                else if (!ElementalInventory.Instance.contains("Cle 3", 1))
                {
                    ElementalInventory.Instance.addItem("Cle 3", 1, randomColor, "Cle qui ouvre la porte de la salle 3");
                }
                else if (!ElementalInventory.Instance.contains("Cle 4", 1))
                {
                    ElementalInventory.Instance.addItem("Cle 4", 1, randomColor, "Cle qui ouvre la porte de la salle 4");
                }
                else if (!ElementalInventory.Instance.contains("Cle 5", 1))
                {
                    ElementalInventory.Instance.addItem("Cle 5", 1, randomColor, "Cle qui ouvre la porte de la salle 5");
                }
                else if (!ElementalInventory.Instance.contains("Cle 6", 1))
                {
                    ElementalInventory.Instance.addItem("Cle 6", 1, randomColor, "Cle qui ouvre la porte de la salle 6");
                }
                else if (!ElementalInventory.Instance.contains("Cle 7", 1))
                {
                    ElementalInventory.Instance.addItem("Cle 7", 1, randomColor, "Cle qui ouvre la porte de la salle 7");
                }
